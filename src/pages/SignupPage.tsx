      ...
      <div className="relative w-full max-w-md animate-fade-up">
        <div className="glass-card rounded-2xl p-8 shadow-2xl">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="font-display text-2xl font-semibold text-white tracking-tight">Create your account</h1>
            <p className="text-sm text-slate-400 mt-1.5">Start collaborating in real time</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPwd ? 'text' : 'password'} className="input-field pr-11" placeholder="At least 8 characters"
            ...
            <div>
              ...
              <input type={showPwd ? 'text' : 'password'} className="input-field" placeholder="Re-enter password"
